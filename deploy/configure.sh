...
BATCH_ACCOUNT_RG_NAME=${3:-$BATCH_ACCOUNT_RG_NAME}
BATCH_ACCOUNT_KEY=${4:-${BATCH_ACCOUNT_KEY}}
...
DETECTION_MODEL_RUN_HOST_TYPE=${10:-${DETECTION_MODEL_RUN_HOST_TYPE:-"batch"}} # possible values: batch or aks
